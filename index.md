...
- Adil Salim, "[Accelerating mathematical research with language models: A case study of an interaction with GPT-5-Pro on a convex analysis problem](https://arxiv.org/pdf/2510.26647)", _ICML 2026 Workshop AI4Research_.
...
- Khashayar Gatmiry, Sitan Chen and Adil Salim, "[High-accuracy and dimension-free sampling with diffusions](https://arxiv.org/abs/2601.10708)", **Oral** @ _ICML 2026_.
...
diffusion models with minimal data assumptions](https://arxiv.org/pdf/2209.11215.pdf)", **Oral** @ _ICLR 2023_.
